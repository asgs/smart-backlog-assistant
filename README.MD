...
whichever dataset is used, the expectation here is it's a CSV file with column names configured in the [config.py](config.py) file
...
9. [Done] - ~~Configure ChromaDB to use hnsw indexing~~
